...
<html>
    ...
    <body>
        ...
        <%-- <h1> Stwórz plan zajęć: </h1> --%>
        
        <br>
        
        <div id="scheduleTabs">
            <ul>
                <li><a href="#tab-1">Stwórz plan spotkań</a></li>
                <c:if test="${uploadItem.schedule != null}">
                    <li><a href="#tab-2">Szczegóły planu</a></li>
                </c:if>
            </ul>
            
            <div id="tab-1">
                <table id="schedule" style="width: 250px">
                    <caption>Stwórz plan</caption>
                    <tr>
                        <th colspan=2> Prześlij plik xml </th>
                    </tr>
                    <tr>
                        <form:form modelAttribute="uploadItem" method="post" enctype="multipart/form-data">
                        <td class="center" style="width: 50%; padding: .1em;">
                                <form:input id="fileInput" path="fileData" type="file" style="display: none"/>
                                <input type="text" id="fileText" style="display: none">
                                <input id="buttonOpen" type="button" value="Wybierz plik" onclick="handleFile()">
                        </td>
                        <td class="center" style="padding: .1em;">
                                <input type="submit" id="buttonSub" value="    Prześlij    " />
                        </td>
                        </form:form>
                    </tr>
                </table>
                ...
                <a href="<%= request.getContextPath() %>/saveSchedule.html" onClick="append_href(this)" id="buttonSave"><tag:message code="schedule.submit"/></a>
            </div>
            ...
            <div id="tab-2">
                ...
                <br>
                <a href="<%= request.getContextPath() %>/downloadSchedule.html?linkID=<c:out value="${uploadItem.link}" />" id="buttonDownload"><tag:message code="schedule.download"/></a>
            </div>
            </c:if>
