...
<%@ page import="pl.com.pk.sutip.lib.schedule.*" %>
    ...
    for (Iterator<Group> iterator = groupMap.iterator(); iterator.hasNext();)
    {
        ...
        %>
            ...
            <table id="schedule" style="width: 1000px;">
                ...
                <tr>
                    <th style="width: 5%"></th>
                    <th style="width: 19%">Poniedziałek</th>
                    <th style="width: 19%">Wtorek</th>
                    <th style="width: 19%">Środa</th>
                    <th style="width: 19%">Czwartek</th>
                    <th style="width: 19%">Piątek</th>
                </tr>
