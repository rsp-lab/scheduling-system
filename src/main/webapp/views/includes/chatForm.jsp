...
<table id="submitTable">
    <tr>
        <security:authorize access="hasRole('ROLE_ANONYMOUS')">
            <td class="right"> Nazwa użytkownika: </td>
        ...
        <td class="right"> Wiadomość: </td>
        <td> <input id="messageText" type="text" /> </td>
        <td class="center" style="width: 10%"> <button id="buttonSend" onclick="saveAjax()" title="Button">Wyślij</button> </td>
    </tr>
</table>

<input id="messagePage" type="hidden" value="${param.sourcePage}"/>

<%-- <a id="buttonSend" href="<%= request.getContextPath() %>/saveMessage.html" onClick="append_href(this)">Wyślij</a> --%>
